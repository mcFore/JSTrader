...
public:
	...
	static std::string MsgQueueToJson(const std::vector<std::string> & msgqueue)
	{
		std::string json;
		for (std::vector<std::string>::const_iterator iter = msgqueue.cbegin(); iter != msgqueue.cend(); ++iter)
		{
			json += (*iter);
			if (iter != msgqueue.cend() - 1)
			{
				json += "|";
			}
		}
	...
	static std::string CandlestickQueueToJson(const std::vector<std::string> & candlestickqueue)
	{
		std::string json;
		for (std::vector<std::string>::const_iterator iter = candlestickqueue.cbegin(); iter != candlestickqueue.cend(); ++iter)
		{
			json += (*iter);
			if (iter != candlestickqueue.cend() - 1)
			{
				json += "|";
			}
		}
	...
	static std::string AccountData(const jsstructs::AccountData& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "account_ctp" },
	...
	static std::string PositionData(const jsstructs::PositionData& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "position_ctp" },
			{ "symbol", data.symbol },
	...
	static std::string ordercallback(const jsstructs::OrderCallback& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "ordercallback_" + gatewayname },
	...
	static std::string cancelordercallback(const jsstructs::OrderCallback& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "cancelordercallback_" + gatewayname },
			{ "orderID", data.orderID },
			{ "direction", data.direction },
			{ "nodealvolume", data.nodealvolume },
			{ "offset", data.offset },
	...
	static std::string tradecallback(const jsstructs::TradeCallback& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "tradecallback_" + gatewayname },
	...
	static std::string strategycallback(const jsstructs::StrategyCallback& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "strategycallback_" + gatewayname },
			{ "strategyname", data.strategyname },
	...
	static std::string updatestrategycallback(const jsstructs::StrategyCallback& data, const std::string &gatewayname)
	{
		json11::Json jsonobj = json11::Json::object{
			{ "msg_head", "updatestrategy_" + gatewayname },
			{ "strategyname", data.strategyname },
			{ "parammap", data.parammap },
			{ "varmap", data.varmap }
	};
	...
	static std::string updatePortfolio(const jsstructs::PortfolioData& data, const std::string &strategyname, const std::string &datetime, const std::string &symbol)
	{
		json11::Json jsonobj = json11::Json::object{
	...
	static std::vector<std::string>JsonToMsgQueue(const std::string &json)
	{
		std::vector<std::string>msgqueue = Utils::split(json, "|");
		return msgqueue;
	}

	static std::vector<std::string>JsonToCandlestickQueue(const std::string &json)
	{
		std::vector<std::string>candlestickqueue = Utils::split(json, "|");
		return candlestickqueue;
	}
